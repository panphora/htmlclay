...
//
// These are the same four facts packaging/windows/register.bat writes with reg.exe.
...
// is embedded as resource 2 by packaging/windows/winres.json and named here by ID.
...
// keeps the value byte for byte what packaging/windows/register.bat has always written.
