# make-tray-ico.ps1 — build tray/icon.ico from tray/icon.png.
#
...
#
# Source is tray/icon.png rather than dist/windows/htmlclay.ico on purpose: the tray
...
#
# Run from the repo root:  powershell -File dist/icons/make-tray-ico.ps1
